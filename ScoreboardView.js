export default class ScoreboardView {
	constructor(root, playerOneName, playerTwoName,onControlButtonClick) {
        ...
        <div class= "input"><input id="text" class="textc" placeholder=" Enter your name "></div>
        
        <div class= "input2"><input id="text" class="textc" placeholder=" Enter your name "></div>
        ...
        <div class = "reset"data-for-player="0">
